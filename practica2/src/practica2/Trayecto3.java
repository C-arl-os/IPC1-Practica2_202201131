 ...
 * @author sanci
 */
public class Trayecto3 extends Thread implements Serializable{
    ...
    public Trayecto3(JLabel etiqueta, Trayectoria moto, int detener) {
    ...
    //contrue
    public Trayecto3(JLabel etiqueta, Trayectoria moto) {
        this.etiqueta = etiqueta;
        this.moto = moto;
    }
            ...
            try {
                ...
                if (aa) {
                    if (etiqueta.getLocation().x >= moto.getBarrera().getLocation().x - 125) {
                        ...
                        JOptionPane.showMessageDialog(null, "Pedido ha llegado de moto 3");
                        fecha = true;
                    }
                    if (moto3 <= moto.getBarrera().getLocation().x - 125) {
