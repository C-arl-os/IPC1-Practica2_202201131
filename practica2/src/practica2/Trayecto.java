 ...
 * @author sanci
 */
public class Trayecto extends Thread implements Serializable {
    ...
    public Trayecto(JLabel etiqueta, Trayectoria moto, int detener) {
    ...
    //contrue
    public Trayecto(JLabel etiqueta, Trayectoria moto) {
        this.etiqueta = etiqueta;
        this.moto = moto;
    }
            ...
            try {
                ...
                if (aa) {
                    if (etiqueta.getLocation().x >= moto.getBarrera().getLocation().x - 125) {
                        ...
                        JOptionPane.showMessageDialog(null, "Pedido ha llegado de moto 1");
                        fecha = true;
                    }
                    if (moto1 <= moto.getBarrera().getLocation().x - 125) {
